...
// making copyText , used in lordicon and here toastify is used to show
    const copyText = (text) => {
    ...
    const deletePassword = (id) => {
        ...
        if(c){
            ...
            // upr line me filter is used to put a condition to delete
    ...
    return (
        <>
        {/* kahi bhi lga skte h but its better to put inside in return  */}
            <ToastContainer
                position="top-right"
                autoClose={5000}
                hideProgressBar={false}
            ...
            <div className=" p-3 md:mycontainer min-h-[83vh] ">
                <h1 className='text-4xl text font-bold text-center'>
                    ...
                    <span>Pass</span><span className='text-zinc-700'>OP/&gt;</span>
                ...
                <div className="flex flex-col p-4 text-black gap-8 items-center">
                    ...
                    <button onClick={savePassword} className='flex justify-center items-center gap-2
                     bg-green-400 hover:bg-gray-500 rounded-full px-8 py-2 w-fit border border-blue-300'>
                        <lord-icon
...
{/* table */}
                ...
                {/* COPY */}
                                    ...
                                    <td className='py-2 border border-white text-center'>
                {/* diff div is made to give flex property  */}
                                        <div className='flex items-center justify-center '>
